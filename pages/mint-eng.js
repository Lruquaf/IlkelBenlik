      ...
      <nav className="navbar-nav">
        <ul className="navbar-list">
          ...
          <li className="navbar-item">
            <a href="./index-eng#about" className="navbar-link">
              About
            </a>
          </li>
          <li className="navbar-item">
            <a href="./index-eng#project" className="navbar-link">
              Project
            </a>
          </li>
          <li className="navbar-item">
            <a href="./index-eng#roadmap" className="navbar-link">
              Roadmap
            </a>
          </li>
          <li className="navbar-item">
            <a href="./index-eng#team" className="navbar-link">
              Team
            </a>
          </li>
          <li className="navbar-item">
            <a href="./index-eng#faq" className="navbar-link">
              Faq
            </a>
          </li>
          <li className="navbar-item">
            ...
            <div className="relative w-full h-full flex flex-col items-center justify-center scale-100">
                ...
                <div className="flex flex-col items-center justify-center h-full w-full px-2 md:px-10">
                    <div className="z-1 md:max-w-3xl w-full bg-[url('../public/assets/img/Arkaplan4.jpg')] bg-cover bg-center bg-no-repeat bg-opacity-30 filter backdrop-blur-sm py-4 rounded-md px-4 md:px10 flex flex-col items-center">
                        ...
                        <h1 className="font-arial italic uppercase font-extrabold text-4xl md:text-5xl text-white mt-3">ID Series</h1>
                        ...
                        <div className="flex flex-col md:flex-row md:space-x-14 w-full mt-10 md:mt-14">
                            ...
                            <div className="flex flex-col items-center w-full px-4 mt-16 md:mt-0">
                                ...
                                <p className="font-agencyr text-sm text-gray-300 tracking-widest mt-3">Max Mint Amount: 5</p>
